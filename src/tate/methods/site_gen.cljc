(ns tate.methods.site-gen
  ...
  index (coverage matrix + critical census) + per-track landing pages, sitemap.xml,
  and robots.txt. Canonical metadata remains EDN; JSON-LD is not emitted.
...
(defn- page [title desc body canonical _structured-data]
  (str "<!DOCTYPE html>\n<html lang=\"ja\">\n<head>\n<meta charset=\"utf-8\">\n"
         ...
         "ソース: <a href=\"https://github.com/etzhayyim/com-etzhayyim-tate\">com-etzhayyim-tate</a>\n"
